...
def customCallback(client, userdata, message):
    ...
    print("from topic: ")
    print(message.topic)
    max_co2_level=message.payload.message
    print("--------------\n\n")
...
print("subscribe to topic ", "co2/max/"+thingName)
myAWSIoTMQTTClient.subscribe("co2/max/"+thingName, 1, customCallback)
time.sleep(2)
#Path to the dataset, modify this
data_path = "./data/{}.csv"
data = []
df = pd.read_csv(data_path.format(thingName))
for index, row in df.iterrows():
    print(row['vehicle_CO2'])

# loopCount = 0
# while True:
    message = {}
    message['vehicle_id'] = thingName
...
print('Max Co2 Level received : %s')